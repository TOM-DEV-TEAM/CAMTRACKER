...
class Mouvement0(models.Model):
    ...
    numconteneur4 = models.CharField(max_length=255, null=True)
    typeconteneur4 = models.CharField(max_length=255, null=True)
    numconteneur5 = models.CharField(max_length=255, null=True)
    typeconteneur5 = models.CharField(max_length=255, null=True)
